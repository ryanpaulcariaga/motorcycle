...
**Resume here:** Phase 4, Stage 1 (admin shell, shared styling, Facebook OAuth2, and BikeModel CRUD). Local development runs PostgreSQL, the API on `https://localhost:7240`, and the public web app on `:3000`; the admin site runs over HTTPS on `:3001`.
